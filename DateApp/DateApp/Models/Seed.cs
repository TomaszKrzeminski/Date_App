    ...
    public static class SeedData
    {
        ...
        public static void EnsurePopulated(AppIdentityDbContext context)
        {
            ...
            if (!context.Users.Any())
            {
                ...
                SeedUser("Mariusz", "Brown", "Kobieta", "Chełmno", "U6@gmail.com", new DateTime(1975, 8, 21));
                SeedUser("Adek", "Teller", "Mężczyzna", "Chełmno", "U7@gmail.com", new DateTime(1980, 8, 21));
                SeedUser("Lolek", "Goldman", "Kobieta", "Bydgoszcz", "U8@gmail.com", new DateTime(1990, 8, 21));
                SeedUser("Weronika", "Rossati", "Mężczyzna", "Świecie", "U9@gmail.com", new DateTime(1999, 8, 21));
                SeedUser("Ania", "Przybylska", "Kobieta", "Bydgoszcz", "U10@gmail.com", new DateTime(2001, 8, 21));
                SeedUser("Karolina", "Świerczyński", "Mężczyzna", "Świecie", "U11@gmail.com", new DateTime(1950, 8, 21));
                SeedUser("Kasia", "Przybylska", "Mężczyzna", "Bydgoszcz", "U12@gmail.com", new DateTime(1992, 8, 21));
